                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 text-right">
                                <div class="col-12 text-right">
                                    <a href="{{route('admin.blogs')}}" class="btn btn-danger waves-effect waves-light">Back</a>
                                    @if($type != 'Detail')
                        ...
                        <div class="form-group">
                            ...
                            <div>
                                <textarea name="short_description" class="form-control" cols="30" rows="5" required placeholder="Enter Short Description" {{ $type == 'Detail' ? 'disabled' : null }}>{{@$data['short_description']}}</textarea>
                            </div>
                        </div>
